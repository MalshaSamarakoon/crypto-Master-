        ...
        <section className="">
          ...
          <section className=" relative">
                ...
                <div className="h-full w-full">
                  <ul className="relative h-full">
                    ...
                    >
                      ...
                      your path to financial success. We are committed to making
                      knowledge accessible to all, offering a wide range of
                      resources and training to help you harness the potential
                      of new technologies and industries. Explore our services
            ...
            <div className="a2a_kit a2a_kit_size_32 a2a_default_style fixed bottom-12 right-12 z-10 w-16 h-16">
              ...
              <a
                href="https://api.whatsapp.com/send?phone=947671131"
                target="_blank"
