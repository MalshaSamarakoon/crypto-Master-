...
export default function Footer() {
  return (
    <>
      <footer
        style={{ backgroundColor: "#8d6e1b0d" }}
          ...
          <footer className=" text-center text-neutral-500  lg:text-left">
            <div className="flex items-center justify-center mb-10">
              ...
              <div className="flex justify-center">
                {/* Box for Facebook */}
                <div className="mr-4 flex items-center justify-center w-8 h-8 border border-neutral-400 rounded-md">
                  <a
                ...
                <div className="">
                  ...
                  <p className="mb-4">
                    <a
                      ...
                      className="text-sm text-neutral-600 dark:text-neutral-200"
                      >
                      School Curriculum Support Classes
                    </a>
                  </p>
                  <p className="mb-4">
                    <a
                  ...
                  <p>
                    <a
                      ...
                      className="text-sm text-neutral-600 dark:text-neutral-200"
                      >
                      Financial Aid and Training Programs
                    </a>
                  </p>
                </div>
                <div>
